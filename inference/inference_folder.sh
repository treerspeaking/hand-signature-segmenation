python -m inference.inference_folder --checkpoint /home/treerspeaking/src/python/hand_seg/logs/hand_segmentation/version_80_test/checkpoints/best_hand_segmentation_epoch=92_val/iou_epoch=0.9180_val/f1_epoch=0.9571.ckpt --folder /home/treerspeaking/src/python/hand_seg/inference/encoded_data --output ./inference/out-unet-base-focal-dice-jaccard-base
